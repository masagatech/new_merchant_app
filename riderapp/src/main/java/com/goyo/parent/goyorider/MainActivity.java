package com.goyo.parent.goyorider;
...
import com.goyo.parent.adapters.dashboard_menuAdapter;
...
import com.goyo.parent.customer.clnt_mykids;
import com.goyo.parent.forms.my_trip;
                                                ...
                                                try {
                                                    ...
                                                    if (login.size() > 0) {
                                                        ...
                                                        if (m.getStatus() == 1) {
                                                            ...
                                                            Intent i = new Intent(MainActivity.this, com.goyo.parent.initials.login.class);
                                                            startActivity(i);
