    ...
    private void SetStudent(List<String> lst,List<String> ID){
        ...
        if(lst.size()==1) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(0), frag_exam_result.class,new Bundler().putString("ID", ID.get(0)).get())
                    .create());
        ...
        if(lst.size()==2) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    getSupportFragmentManager(), FragmentPagerItems.with(this)
                    .add(lst.get(0), frag_exam_result.class,new Bundler().putString("ID", ID.get(0)).get())
                    .add(lst.get(1), frag_exam_result.class,new Bundler().putString("ID", ID.get(1)).get())
                    .create());
        ...
        if(lst.size()==3) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(0), frag_exam_result.class,new Bundler().putString("ID", ID.get(0)).get())
                    .add(lst.get(1), frag_exam_result.class,new Bundler().putString("ID", ID.get(1)).get())
                    .add(lst.get(2), frag_exam_result.class,new Bundler().putString("ID", ID.get(2)).get())
                    .create());
        ...
        if(lst.size()==4) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(1), frag_exam_result.class,new Bundler().putString("ID", ID.get(1)).get())
                    .add(lst.get(2), frag_exam_result.class,new Bundler().putString("ID", ID.get(2)).get())
                    .add(lst.get(3), frag_exam_result.class,new Bundler().putString("ID", ID.get(3)).get())
                    .create());
        ...
        if(lst.size()==5) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(2), frag_exam_result.class,new Bundler().putString("ID", ID.get(2)).get())
                    .add(lst.get(3), frag_exam_result.class,new Bundler().putString("ID", ID.get(3)).get())
                    .add(lst.get(4), frag_exam_result.class,new Bundler().putString("ID", ID.get(4)).get())
                    .create());
