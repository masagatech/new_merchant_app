...
public class Ann extends AppCompatActivity {
    ...
    private void SetStudent(List<String> lst,List<String> ID){
        ...
        if(lst.size()==1) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(0), Student_Leave.class,new Bundler().putString("ID", ID.get(0)).get())
                    .create());
        ...
        if(lst.size()==2) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    getSupportFragmentManager(), FragmentPagerItems.with(this)
                    .add(lst.get(0), Student_Leave.class,new Bundler().putString("ID", ID.get(0)).get())
                    .add(lst.get(1), Student_Leave.class,new Bundler().putString("ID", ID.get(1)).get())
                    .create());
        ...
        if(lst.size()==3) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(0), Student_Leave.class,new Bundler().putString("ID", ID.get(0)).get())
                    .add(lst.get(1), Student_Leave.class,new Bundler().putString("ID", ID.get(1)).get())
                    .add(lst.get(2), Student_Leave.class,new Bundler().putString("ID", ID.get(2)).get())
                    .create());
        ...
        if(lst.size()==4) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(1), Student_Leave.class,new Bundler().putString("ID", ID.get(1)).get())
                    .add(lst.get(2), Student_Leave.class,new Bundler().putString("ID", ID.get(2)).get())
                    .add(lst.get(3), Student_Leave.class,new Bundler().putString("ID", ID.get(3)).get())
                    .create());
        ...
        if(lst.size()==5) {
            FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(lst.get(2), Student_Leave.class,new Bundler().putString("ID", ID.get(2)).get())
                    .add(lst.get(3), Student_Leave.class,new Bundler().putString("ID", ID.get(3)).get())
                    .add(lst.get(4), Student_Leave.class,new Bundler().putString("ID", ID.get(4)).get())
                    .create());
