...
import com.goyo.parent.model.modal_assignment;
...
public class AllOrdersAdapter extends RecyclerView.Adapter<pending_order_viewHolder>  {
    ...
    private List<modal_assignment> mFeedList;
    ...
    public AllOrdersAdapter(List<modal_assignment> feedList, Orientation orientation, boolean withLinePadding, int []stat) {
        mFeedList = feedList;
    ...
    public void onBindViewHolder(final pending_order_viewHolder holder, final int position) {
        ...
        final modal_assignment timeLineModel = mFeedList.get(position);
...
//        }
            ...
            holder.mDate.setText(timeLineModel.subname + "");
            holder.mMarchant.setText(timeLineModel.title+"");
            holder.Custmer_name.setText(timeLineModel.studentname+"");
            holder.mDeliver_at.setText(timeLineModel.classname+"");
            holder.mTime.setText(timeLineModel.msg+"");
            holder.Remark.setText(timeLineModel.todt+"");
