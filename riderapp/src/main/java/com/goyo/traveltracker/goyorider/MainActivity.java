package com.goyo.traveltracker.goyorider;
...
import com.goyo.traveltracker.adapters.dashboard_menuAdapter;
...
import com.goyo.traveltracker.customer.clnt_mykids;
import com.goyo.traveltracker.forms.my_trip;
                                                ...
                                                try {
                                                    ...
                                                    if (login.size() > 0) {
                                                        ...
                                                        if (m.getStatus() == 1) {
                                                            ...
                                                            Intent i = new Intent(MainActivity.this, com.goyo.traveltracker.initials.login.class);
                                                            startActivity(i);
