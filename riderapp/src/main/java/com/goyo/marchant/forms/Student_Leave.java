...
import com.goyo.marchant.adapters.LeaveAdapter;
...
import static com.goyo.marchant.gloabls.Global.urls.getPassengerLeave;

public class Student_Leave extends Fragment {

    private View view;
    private RecyclerView mRecyclerView;
    private com.goyo.marchant.adapters.LeaveAdapter mTimeLineAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.activity_student__leave, container, false);
        ...
        //Add Leave
        AddLeave=(FloatingActionButton)view.findViewById(R.id.add_Leave);
...
//        setContentView(R.layout.activity_student__leave);
...
//                    }
    ...
    private void bindCurrentTrips(List<modal_data> lst) {
        if (lst.size() > 0) {
            ...
            mTimeLineAdapter = new LeaveAdapter(lst, mOrientation, mWithLinePadding);
