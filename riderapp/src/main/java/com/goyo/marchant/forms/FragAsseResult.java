...
import com.goyo.marchant.adapters.AsseFragAdapter;
...
import static com.goyo.marchant.forms.AssesmentFrag.IDs;
 ...
 */
public class FragAsseResult extends Fragment {

    private View view;
    private RecyclerView mRecyclerView;
    private com.goyo.marchant.adapters.AsseFragAdapter mTimeLineAdapter;
...
//                    }
    ...
    private void bindCurrentTrips(List<modal_data> lst) {
        if (lst.size() > 0) {
            ...
            mTimeLineAdapter = new AsseFragAdapter(lst, mOrientation, mWithLinePadding);
