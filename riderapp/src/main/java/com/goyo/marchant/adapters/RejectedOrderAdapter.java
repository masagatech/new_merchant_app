...
//        final String time = s.split(",")[1]; // "After"
    ...
    holder.mTime.setText(timeLineModel.hlddesc+"");
        holder.mDate.setText(timeLineModel.hlddate+"");
        holder.mOrder.setText(timeLineModel.hldnm+"");
//        holder.mDeliver_at.setText("To : "+timeLineModel.todt);
//        if(TagsArray!=null) {
